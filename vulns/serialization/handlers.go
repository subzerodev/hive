...
func jsonDeserialize(w http.ResponseWriter, r *http.Request) {
	if r.Method == http.MethodPost {
		...
		if err := decoder.Decode(&data); err != nil {
			...
			fmt.Fprintf(w, `<html><body><h1>Error</h1><pre>%v</pre></body></html>`, err)
			return
		}
...
<html>
<head><title>JSON Deserialized</title></head>
<body>
...
<a href="/vulns/serialization/json">Back</a>
	...
	fmt.Fprintf(w, `<!DOCTYPE html>
<html>
<head><title>JSON Deserialization</title></head>
<body>
...
func xmlDeserialize(w http.ResponseWriter, r *http.Request) {
	if r.Method == http.MethodPost {
		...
		fmt.Fprintf(w, `<!DOCTYPE html>
<html>
<head><title>XML Deserialized</title></head>
<body>
...
<a href="/vulns/serialization/xml">Back</a>
	...
	fmt.Fprintf(w, `<!DOCTYPE html>
<html>
<head><title>XML Deserialization</title></head>
<body>
...
func fpSafe(w http.ResponseWriter, r *http.Request) {
	if r.Method == http.MethodPost {
		...
		if err := decoder.Decode(&data); err != nil {
			w.Header().Set("Content-Type", "text/html")
			fmt.Fprintf(w, `<html><body><h1>Error</h1><pre>%v</pre><a href="/vulns/serialization/fp/safe">Back</a></body></html>`, err)
			return
		}
		...
		fmt.Fprintf(w, `<!DOCTYPE html>
<html>
<head><title>Safe Deserialization</title></head>
<body>
